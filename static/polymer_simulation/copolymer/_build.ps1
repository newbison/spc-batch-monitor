...
$files = @(
    ...
    (Join-Path $root 'copolymer\simulation.js'),
    (Join-Path $root 'copolymer\theme.js'),
    (Join-Path $root 'copolymer\ui.js'),
    (Join-Path $root 'copolymer\main.js')
)
...
$outputPath = Join-Path $root 'copolymer\bundle.js'
