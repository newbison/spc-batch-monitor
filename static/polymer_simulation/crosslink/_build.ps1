...
$files = @(
    ...
    (Join-Path $root 'crosslink\simulation.js'),
    (Join-Path $root 'crosslink\theme.js'),
    (Join-Path $root 'crosslink\ui.js'),
    (Join-Path $root 'crosslink\main.js')
)
...
$outputPath = Join-Path $root 'crosslink\bundle.js'
