...
Create `D:\coding_is_fun\SPC\tests\test_doe_designs.py`:
...
Create `D:\coding_is_fun\SPC\doe\__init__.py` (empty file).

- [ ] **Step 4: Implement designs.py**

Create `D:\coding_is_fun\SPC\doe\designs.py`:
...
Create `D:\coding_is_fun\SPC\tests\test_doe_analysis.py`:
...
Create `D:\coding_is_fun\SPC\doe\analysis.py`:
...
Create `D:\coding_is_fun\SPC\tests\test_doe_optimization.py`:
...
Create `D:\coding_is_fun\SPC\doe\optimization.py`:
...
Create `D:\coding_is_fun\SPC\tests\test_doe_persistence.py`:
...
Create `D:\coding_is_fun\SPC\doe\persistence.py`:
...
In `D:\coding_is_fun\SPC\ui\common\sidebar.py`, change line 33 from:
...
In `D:\coding_is_fun\SPC\app.py`, add the import after line 7:
...
Create `D:\coding_is_fun\SPC\ui\engineer\doe_view.py`:
...
Append to `D:\coding_is_fun\SPC\ui\engineer\doe_view.py` after the `_render_define` function:
...
Append to `D:\coding_is_fun\SPC\ui\engineer\doe_view.py` after the `_render_design` function:
...
Append to `D:\coding_is_fun\SPC\ui\engineer\doe_view.py` after the `_render_capture` function. This requires imports at the top of the file (add after existing imports):
...
Append to `D:\coding_is_fun\SPC\ui\engineer\doe_view.py` after the `_promote_to_full_factorial` function:
