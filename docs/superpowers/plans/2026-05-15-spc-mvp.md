...
Run:
```bash
touch D:/coding_is_fun/SPC/data_access/__init__.py
touch D:/coding_is_fun/SPC/spc_engine/__init__.py
touch D:/coding_is_fun/SPC/visualization/__init__.py
touch D:/coding_is_fun/SPC/ui/__init__.py
touch D:/coding_is_fun/SPC/ui/common/__init__.py
touch D:/coding_is_fun/SPC/ui/operator/__init__.py
touch D:/coding_is_fun/SPC/ui/engineer/__init__.py
touch D:/coding_is_fun/SPC/ui/manager/__init__.py
touch D:/coding_is_fun/SPC/tests/__init__.py
touch D:/coding_is_fun/SPC/data/.gitkeep
mkdir -p D:/coding_is_fun/SPC/data/uploads
touch D:/coding_is_fun/SPC/data/uploads/.gitkeep
```

- [ ] **Step 4: Install dependencies**

```bash
pip install -r D:/coding_is_fun/SPC/requirements.txt
```
...
```bash
cd D:/coding_is_fun/SPC && python data/generate_samples.py
```
...
```bash
cd D:/coding_is_fun/SPC && python -m pytest tests/test_control_limits.py -v
```
...
```bash
cd D:/coding_is_fun/SPC && python -m pytest tests/test_rules.py -v
```
Expected: FAIL with ModuleNotFoundError.
...
```bash
cd D:/coding_is_fun/SPC && python -m pytest tests/test_capability.py -v
```
Expected: FAIL with ModuleNotFoundError.
...
```bash
cd D:/coding_is_fun/SPC && python -c "from visualization.control_charts import build_xbar_r_chart; print('OK')"
```
...
```bash
cd D:/coding_is_fun/SPC && python -c "from visualization.capability import build_capability_chart; print('OK')"
```
...
```bash
cd D:/coding_is_fun/SPC && streamlit run app.py --server.headless true &
...
```bash
cd D:/coding_is_fun/SPC && python -m pytest tests/test_integration.py -v
```
Expected: 1 passed.
